...
public class InserirFragment extends Fragment {
    ...
    private SelecaoFotoAdapter photoAdapter;
...
/* ---------------------------------- Métodos Data Binding -------------------------------------- */
    ...
    private void clickable() {
        ...
        photoAdapter.setMarcarItem(marcarFoto);
        ...
        photoAdapter.setSelecionarItem(selecionarFoto);
