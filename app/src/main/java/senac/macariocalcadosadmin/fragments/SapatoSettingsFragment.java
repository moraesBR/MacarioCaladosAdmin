        ...
        onPreferenceChangeListener = new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                if(preference instanceof SwitchPreference){
                    if(preference.getKey().equalsIgnoreCase(getResources().getString(R.string.credencials))
                    ...
                    if (preference.getKey().equalsIgnoreCase(getResources().getString(R.string.notification))
                            && !((SwitchPreference) preference).isChecked()){
